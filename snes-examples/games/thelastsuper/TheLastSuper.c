...
const u16 playerAnim[]=
{
384, 388
}; //Sprites are 32x32 here, so 4 frames per "row", and jumping a line imply adding 64 to the first index of the line
...
const u16 foeAnim[]=
{
128, 132, 136, 140, 192, 196, 200, 204, 256, 260, 264, 268, 320, 324, 328, 332
}; //Sprites are 32x32 here, so 4 frames per "row", and jumping a line imply adding 64 to the first index of the line
const u16 consoleAnim[]={
448
}; //Sprites are 32x32 here, so 4 frames per "row", and jumping a line imply adding 64 to the first index of the line
...
//32x32 sprites are stored at 0x6000 (as we won't use the 16x16 ones) => their first tile index is 0
const u16 boomAnim[9]=
{
460, 0, 4, 8, 12, 64, 68, 72, 76
}; //Sprites are 32x32 here, so 4 frames per "row", and jumping a line imply adding 64 to the first index of the line
