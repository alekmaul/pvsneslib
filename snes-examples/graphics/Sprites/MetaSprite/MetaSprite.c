...
#include "spritehero16_1_meta.inc"
#include "spritehero16_1.inc"
#include "spritehero16_1.inc"
...
int main(void)
{
    ...
    bgInitMapSet(0, (u8 *) &pvsneslib_map, (&pvsneslib_mapend - &pvsneslib_map), SC_32x32, 0x6800);
    ...
    dmaCopyVram((u8 *) &spritehero16_til,0x1600, (&spritehero16_tilend - &spritehero16_til));
    dmaCopyVram((u8 *) &spritehero16_1_til,0x1000, (&spritehero16_1_tilend - &spritehero16_1_til));
    // if size 8 enable dmaCopyVram((u8 *) &spritehero8_til,0x1600, (&spritehero8_tilend - &spritehero8_til));
    ...
    oamMetaDraw16(8, 144,140, (u8 *) spritehero16_metasprites[0],OBJ_SMALL,0x0600);
    oamMetaDraw16(16, 184,140, (u8 *) spritehero16_1_metasprites[0],OBJ_SMALL,0x0000);
    //if size 8 enable oamMetaDraw8(16, 200,140, (u8 *) spritehero8_metasprites[0],0x0600);
