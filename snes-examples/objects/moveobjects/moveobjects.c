...
{
    15,5, 0, 0,0,                    // no min & max x speified
    100,5, 0, 0,0,                   // no min & max x speified
    5,15, 0, 0,0,                    // no min & max x speified
    150,150, 0, 0,0,                 // no min & max x speified
    200,50, 0, 0,0,                  // no min & max x speified
    125,25, 0, 0,0,                  // no min & max x speified
    200,25, 0, 0,0,                  // no min & max x speified
...
void testUpdate(u8 idx) {
    ...
    snesox = (u16 *) &(snesobj->xpos+1);  snesoy = (u16 *) &(snesobj->ypos+1);  
    xp = *snesox; yp=*snesoy;
