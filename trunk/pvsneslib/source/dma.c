...
void setModeHdmaShading(unsigned char mode) {
	...
	data_to_transfert.mem.p = (u8 *) (Lvl1Shading+142);
	...
	data_to_transfert.mem.p = (u8 *) (Lvl1Shading+284);
