\hypertarget{a00432}{}\section{scoring/scoring.\+c}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00341_a610bffa01efc5915459764c57f0a7d32}{scoreClear}(&scoretst);
    sprintf(sz,\textcolor{stringliteral}{"score hi %04x score lo %04x"},(u16) scoretst.scohi,(u16) scoretst.scolo);
    \hyperlink{a00320_a7e52d15b5a1befa42f5758de19dfb70c}{consoleDrawText}(2,8,sz);
    
    \textcolor{comment}{// Add a value}
    \hyperlink{a00341_a95d4103529817bc4d7efbaa7098ae2e5}{scoreAdd}(&scoretst,0x4DB);
    sprintf(sz,\textcolor{stringliteral}{"score hi %04x score lo %04x"},(u16) scoretst.scohi,(u16) scoretst.scolo);
    \hyperlink{a00320_a7e52d15b5a1befa42f5758de19dfb70c}{consoleDrawText}(2,9,sz);

    \textcolor{comment}{// Add more than 10000}
    \hyperlink{a00341_a95d4103529817bc4d7efbaa7098ae2e5}{scoreAdd}(&scoretst,0x2710);
    sprintf(sz,\textcolor{stringliteral}{"score hi %04x score lo %04x"},(u16) scoretst.scohi,(u16) scoretst.scolo);
    \hyperlink{a00320_a7e52d15b5a1befa42f5758de19dfb70c}{consoleDrawText}(2,10,sz);
