\hypertarget{a00436}{}\section{graphics/\+Effects/\+Mosaic\+Shading/\+Mosaic\+Shading.\+c}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00347_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(0, &patterns, &palette, 0, (&patterns\_end - &patterns), (&palette\_end - &
      palette), BG\_16COLORS, 0x4000);

    \textcolor{comment}{// Copy Map to VRAM}
    \hyperlink{a00347_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(0, &map, (&map\_end - &map),\hyperlink{a00347_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x1000);
    ...
    \hyperlink{a00365_a42632e79292dc47a567aab4dc3e4407d}{scanPads}(); \textcolor{keywordflow}{while} (!\hyperlink{a00365_a6063e0eec9a36e437fc32951acafa44c}{padsCurrent}(0)) \hyperlink{a00365_a42632e79292dc47a567aab4dc3e4407d}{scanPads}(); 
    
    \textcolor{comment}{// Now just play withj effects :P}
    \textcolor{keywordflow}{while}(1) \{
        \textcolor{comment}{// Fade out so light to black}
        \hyperlink{a00383_ac34bd13a8556c8ac8e1eeeded15f7632}{setFadeEffect}(FADE\_OUT);
        \hyperlink{a00356_a815e2626bd26d0e936d507a363ecd723}{WaitForVBlank}();
        \textcolor{keywordflow}{while} (!\hyperlink{a00365_a6063e0eec9a36e437fc32951acafa44c}{padsCurrent}(0));

        \textcolor{comment}{// Fade in now so black to light }
        \hyperlink{a00383_ac34bd13a8556c8ac8e1eeeded15f7632}{setFadeEffect}(FADE\_IN);
        \hyperlink{a00356_a815e2626bd26d0e936d507a363ecd723}{WaitForVBlank}();
        \textcolor{keywordflow}{while} (!\hyperlink{a00365_a6063e0eec9a36e437fc32951acafa44c}{padsCurrent}(0)) ;

        \textcolor{comment}{// And now restore screen to normal}
        \hyperlink{a00383_aa14785c4eb1ce08cc02eb98d26c98c44}{setMosaicEffect}(MOSAIC\_IN,MOSAIC\_BG1);
        \hyperlink{a00356_a815e2626bd26d0e936d507a363ecd723}{WaitForVBlank}();
        \textcolor{keywordflow}{while} (!\hyperlink{a00365_a6063e0eec9a36e437fc32951acafa44c}{padsCurrent}(0)) ;

        \textcolor{comment}{// Now do some big pixels }
        \hyperlink{a00383_aa14785c4eb1ce08cc02eb98d26c98c44}{setMosaicEffect}(MOSAIC\_OUT,MOSAIC\_BG1);
        \hyperlink{a00356_a815e2626bd26d0e936d507a363ecd723}{WaitForVBlank}();
        \textcolor{keywordflow}{while} (!\hyperlink{a00365_a6063e0eec9a36e437fc32951acafa44c}{padsCurrent}(0)) ;
    \}
