\hypertarget{a00420}{}\section{games/likemario/\+Like\+Mario.\+c}
...
\hyperlink{a00382}{brrsamples} Jump; \textcolor{comment}{// The sound for jumping}
...
\textcolor{keywordtype}{void} moveLevel(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} direction) \{
    ...
    \hyperlink{a00353_a09d7fb089889aaa434f7c88ebccb5190}{REG\_VMAIN} = VRAM\_INCHIGH | \hyperlink{a00353_a5623bfd6fefb79d4f21d260b7e333523acbbc69e337e06fc13a5f572284c5ddfe}{VRAM\_ADRTR\_0B} | 
      \hyperlink{a00353_a5623bfd6fefb79d4f21d260b7e333523acfee058cf30c9aacc05573725e3775d8}{VRAM\_ADRSTINC\_1}; \textcolor{comment}{// set address in VRam for read or write ($2116) + block size transfer
       ($2115)}
    \hyperlink{a00353_a962038681293a309df2c26f1e9a7d7e9}{REG\_VMADDLH} = 0x1000;
    ...
    \textcolor{keywordflow}{if} (direction == W\_RIGHT) \{
        ...
        \textcolor{keywordflow}{if} ( (scrX &7) == 0) \{ \textcolor{comment}{// to avoid to bee too slow}
            ...
            \hyperlink{a00326_a03304aaf535795c2857e357e028cdebe}{WaitVBLFlag};
            \textcolor{keywordflow}{for} (i=0;i<16;i++) \{
                u16 value = *ptrMap;
                \hyperlink{a00353_a962038681293a309df2c26f1e9a7d7e9}{REG\_VMADDLH} = ptrVRAM;
                \hyperlink{a00353_a2e1221b6655ab3ef51d4e0e465990e92}{REG\_VMDATALH} = value ;
                ptrVRAM += 32;
                ptrMap += 300;
            \}
        \}
    ...
    \hyperlink{a00317_aa5e0112ea2d4b514c2dddc6ed2c7c3c7}{bgSetScroll}(1,scrX,0);
\}
...
\textcolor{keywordtype}{void} moveMario(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} padvalue) \{
    ...
    \textcolor{keywordflow}{if} (padvalue & (\hyperlink{a00335_aa27cad8fa018a58930b6622783a83072a6504370d9c6391e1a9da6a1a529b089d}{KEY\_RIGHT} | \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072a612120b69c7dfd46086db7aaebdbcf65}{KEY\_LEFT} | \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072aa7b3a3d0503a46bec51c6e3da95747cc}{KEY\_A}) ) \{
        \textcolor{keywordflow}{if} (padvalue & \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072a6504370d9c6391e1a9da6a1a529b089d}{KEY\_RIGHT}) \{ 
        ...
        \textcolor{keywordflow}{if} (padvalue & \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072a612120b69c7dfd46086db7aaebdbcf65}{KEY\_LEFT})  \{
        ...
        \textcolor{keywordflow}{if} (padvalue & \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072aa7b3a3d0503a46bec51c6e3da95747cc}{KEY\_A}) \{
    ...
    \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (padvalue & \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072aa9cdac7967bf7d88fdb761138a2a3416}{KEY\_DOWN}) \{
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00347_ad8753cb6edb38834257bbf0020700689}{spcBoot}();
    ...
    \hyperlink{a00347_ab68840ba8aab786b8ea206ea077acaac}{spcSetBank}(&\_\_SOUNDBANK\_\_);
    
    \textcolor{comment}{// allocate around 10K of sound ram (39 256-byte blocks)}
    \hyperlink{a00347_a2113060be24b307d1e03f167eb241b90}{spcAllocateSoundRegion}(39);

    \textcolor{comment}{// Load music}
    \hyperlink{a00347_a313e30fb1962df9fb469f2fedd4d91e4}{spcLoad}(MOD\_OVERWORLD);
    
    \textcolor{comment}{// Load sample}
    \hyperlink{a00347_a4ef9d5d4b7618a2e091194b6c17f75a5}{spcSetSoundEntry}(15, 8, 6, &jumpsndend-&jumpsnd, &jumpsnd, &Jump);
    ...
    \hyperlink{a00320_ac0993a72682f86d17784a7f4659562de}{consoleSetTextCol}(\hyperlink{a00353_abd4530c7880d389c9ea70e2e3b84aa9d}{RGB15}(0,0,0), \hyperlink{a00353_abd4530c7880d389c9ea70e2e3b84aa9d}{RGB15}(31,31,31));
    
    \textcolor{comment}{// Copy tiles to VRAM}
    \hyperlink{a00317_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(1, &mapgfx, &mappal, 0, (&mapgfx\_end - &mapgfx), 16*2, BG\_16COLORS, 0x6000);

    \textcolor{comment}{// Init Sprites gfx and palette with default size of 16x16}
    \hyperlink{a00350_a46e0be47f8fc865a7f43c1b0b126e59a}{oamInitGfxSet}(&mariogfx, (&mariogfx\_end-&mariogfx), &mariopal, 16*2, 0, 0x4000, 
    ...
    \hyperlink{a00317_a4fcbdb4b2378a64e8db62a184ee1851e}{bgSetMapPtr}(1, 0x1000, \hyperlink{a00317_a6129b86a7c2913a31f1bca293fa7c1e7}{SC\_64x32});
    \textcolor{keywordflow}{for} (i=0;i<31;i++) \{ \textcolor{comment}{// 128 pixel height -> 128/8 = 16 2400 / 8 = 300}
        ...
        \hyperlink{a00323_aaf545b3f811f6ef4b7c4be434701a77a}{dmaCopyVram}(ptrMap, ptrVRAM, 32*2); \textcolor{comment}{// copy row to VRAM }
        \hyperlink{a00323_aaf545b3f811f6ef4b7c4be434701a77a}{dmaCopyVram}((ptrMap+32*2), (ptrVRAM+32*32), 32*2); \textcolor{comment}{// copy row to VRAM }
    \}
    ...
    \hyperlink{a00350_a2f62a591672b786d90ebb03fdf25f159}{oamSet}(0,  (mario.x>>8), (mario.y>>8), 3, mario.flipx, 0, mario.anim\_frame*2, 0);  \textcolor{comment}{// flip x and
       take 5th sprite}
    ...
    \hyperlink{a00320_a7e52d15b5a1befa42f5758de19dfb70c}{consoleDrawText}(6,16,\textcolor{stringliteral}{"MARIOx00  WORLD TIME"});
    \hyperlink{a00320_a7e52d15b5a1befa42f5758de19dfb70c}{consoleDrawText}(6,17,\textcolor{stringliteral}{" 00000 ox00 1-1  000"});
    ...
    \hyperlink{a00347_aebf91de1df5e4fa83454a84bb0e60918}{spcPlay}(0);\hyperlink{a00347_ae2c8dfab62ceecf5c302c95f5453a752}{spcSetModuleVolume}(100);
    ...
    \textcolor{keywordflow}{while}(1) \{
        ...
        \hyperlink{a00350_a2f62a591672b786d90ebb03fdf25f159}{oamSet}(0,  (mario.x>>8), (mario.y>>8), 3, mario.flipx, 0, mario.anim\_frame*2, 0);
