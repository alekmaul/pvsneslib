\hypertarget{a00408}{}\section{graphics/\+Effects/\+Transparency/\+Transparency.\+c}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00317_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(0, &LandTiles, &LandPalette, 1, (&LandTiles\_end - &LandTiles), (&
      LandPalette\_end - &LandPalette), BG\_16COLORS, 0x0000);
    \hyperlink{a00317_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(2, &CloudTiles, &CloudPalette, 0, (&CloudTiles\_end - &CloudTiles), (&
      CloudPalette\_end - &CloudPalette),  BG\_4COLORS, 0x1000);

    \textcolor{comment}{// Copy Map to VRAM}
    \hyperlink{a00317_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(0, &Maps, (&Maps\_end - &Maps),\hyperlink{a00317_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x2000);
    \hyperlink{a00317_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(2, &Mapsc, (&Mapsc\_end - &Mapsc),\hyperlink{a00317_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x2400);
