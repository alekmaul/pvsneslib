\hypertarget{a00429}{}\section{graphics/\+Sprites/\+Dynamic\+Sprite/\+Dynamic\+Sprite.\+c}
...
\textcolor{keywordtype}{void} myconsoleVblank(\textcolor{keywordtype}{void}) \{
    ...
    \textcolor{keywordflow}{if} (spr\_queue != 0xff) \{
        \textcolor{keywordflow}{if} (spr\_mutex == 0) \{ \textcolor{comment}{// if we have finished adding things }
            ...
            \textcolor{keywordflow}{while} (spr\_queue != 0xff) \{
                ...
                \hyperlink{a00338_aaf545b3f811f6ef4b7c4be434701a77a}{dmaCopyVram}(pgfx, padrgfx, 8*4*2); \hyperlink{a00338_aaf545b3f811f6ef4b7c4be434701a77a}{dmaCopyVram}(pgfx+8*4*16, padrgfx+8
      *4*8, 8*4*2);
                spr\_queue--;
            \}
        \}
    ...
    \hyperlink{a00338_a2f9585bce8262424ff3e8121c6a9e44e}{dmaCopyOAram}((\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} *) &oamMemory,0,0x220);
    
    \textcolor{comment}{// count vbls}
    \hyperlink{a00335_a5e14b74b621c822db9af978d0ad31d1a}{snes\_vblank\_count}++;
\}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00365_a46e0be47f8fc865a7f43c1b0b126e59a}{oamInitGfxSet}(&gfxpsrite, 2, &palsprite, 16*2, 0, ADRGFXSPR, 
      \hyperlink{a00365_a35664c2c4a66c3bac8139ae093d7f3ac}{OBJ\_SIZE16});

    \textcolor{comment}{// Define sprites parmaters}
    \hyperlink{a00365_a2f62a591672b786d90ebb03fdf25f159}{oamSet}(0,  100, 100, 3, 0, 0, 0, 0); \textcolor{comment}{// Put sprite in 100,100, with maximum priority 3 from tile
       entry 0, palette 0}
    ...
    \textcolor{keywordflow}{while}(1) \{
        ...
        \textcolor{keywordflow}{if} (pad0) \{
            ...
            \textcolor{keywordflow}{if}(pad0 & \hyperlink{a00350_aa27cad8fa018a58930b6622783a83072aa7b3a3d0503a46bec51c6e3da95747cc}{KEY\_A}) \{
