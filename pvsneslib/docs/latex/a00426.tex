\hypertarget{a00426}{}\section{graphics/\+Backgrounds/\+Mode1\+Scroll/\+Mode1\+Scroll.\+c}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00347_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(1, &patterns, &palette, 0, (&patterns\_end - &patterns), 16*2, BG\_16COLORS, 0
      x4000);

    \textcolor{comment}{// Copy Map to VRAM}
    \hyperlink{a00347_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(1, &map, (&map\_end - &map),\hyperlink{a00347_ace76b0c992e2cba05f6da76f9825720a}{SC\_64x64}, 0x1000);
    ...
    \textcolor{keywordflow}{while}(1) \{
        ...
        \textcolor{keywordflow}{switch} (pad0) \{
            \textcolor{keywordflow}{case} \hyperlink{a00365_aa27cad8fa018a58930b6622783a83072a6504370d9c6391e1a9da6a1a529b089d}{KEY\_RIGHT} : scrX+=2; move = 1; \textcolor{keywordflow}{break};
            \textcolor{keywordflow}{case} \hyperlink{a00365_aa27cad8fa018a58930b6622783a83072a612120b69c7dfd46086db7aaebdbcf65}{KEY\_LEFT}   : scrX-=2; move = 1; \textcolor{keywordflow}{break};
            \textcolor{keywordflow}{case} \hyperlink{a00365_aa27cad8fa018a58930b6622783a83072aa9cdac7967bf7d88fdb761138a2a3416}{KEY\_DOWN}   : scrY+=2; move = 1; \textcolor{keywordflow}{break};
            \textcolor{keywordflow}{case} \hyperlink{a00365_aa27cad8fa018a58930b6622783a83072a0848a442d907968b211b97bc2bd88acd}{KEY\_UP}       : scrY-=2; move = 1; \textcolor{keywordflow}{break};
        \}
        \textcolor{keywordflow}{if} (move) \hyperlink{a00347_aa5e0112ea2d4b514c2dddc6ed2c7c3c7}{bgSetScroll}(1, scrX,scrY);
        
        \textcolor{comment}{// Just inform user}
        \hyperlink{a00350_a7e52d15b5a1befa42f5758de19dfb70c}{consoleDrawText}(0,0,\textcolor{stringliteral}{"SCR X=%d Y=%d"},scrX,scrY);
