\hypertarget{a00360}{}\section{graphics/\+Backgrounds/\+Mode0/\+Mode0.\+c}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00287_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(0, &t0, &p0, 0, (&t0\_end - &t0), 8, BG\_4COLORS0, 0x2000);
    \hyperlink{a00287_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(1, &t1, &p1, 0, (&t1\_end - &t1), 8, BG\_4COLORS0, 0x3000);
    \hyperlink{a00287_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(2, &t2, &p2, 0, (&t2\_end - &t2), 8, BG\_4COLORS0, 0x4000);
    \hyperlink{a00287_ae09a7ac09be78eef0f28a6c7aabc82ad}{bgInitTileSet}(3, &t3, &p3, 0, (&t3\_end - &t3), 16, BG\_4COLORS0, 0x5000);

    \textcolor{comment}{// Copy Map to VRAM}
    \hyperlink{a00287_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(0, &m0, (&m0\_end - &m0),\hyperlink{a00287_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x0000);
    \hyperlink{a00287_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(1, &m1, (&m1\_end - &m1),\hyperlink{a00287_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x0400);
    \hyperlink{a00287_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(2, &m2, (&m2\_end - &m2),\hyperlink{a00287_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x0800);
    \hyperlink{a00287_acc385296e159449a81d18f5e219c8032}{bgInitMapSet}(3, &m3, (&m3\_end - &m3),\hyperlink{a00287_a11724b6748ce0954e9b43819263537fc}{SC\_32x32}, 0x0C00);

    \textcolor{comment}{// Now Put in 16 color mode and disable other BGs except 1st one}
    \hyperlink{a00323_afd9e46ae627d055dd8c98a4b0ebb73b1}{setMode}(\hyperlink{a00287_a82bccfa80c8aa4ff5aa4e1416e0ade25}{BG\_MODE0},0);  
    ...
    \textcolor{keywordflow}{while}(1) \{
        ...
        \textcolor{keywordflow}{if} (flip == 3) \{
            ...
            sxbg2+=2;
            sxbg1+=3;
            \hyperlink{a00287_aa5e0112ea2d4b514c2dddc6ed2c7c3c7}{bgSetScroll}(1,sxbg1,0);
            \hyperlink{a00287_aa5e0112ea2d4b514c2dddc6ed2c7c3c7}{bgSetScroll}(2,sxbg2,0);
            \hyperlink{a00287_aa5e0112ea2d4b514c2dddc6ed2c7c3c7}{bgSetScroll}(3,sxbg3,0);
        \}
