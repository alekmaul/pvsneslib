\hypertarget{a00414}{}\section{graphics/\+Sprites/\+Dynamic\+Sprite/\+Dynamic\+Sprite.\+c}
    ...
    \textcolor{keywordflow}{if} (spr\_queue != 0xff) \{
        \textcolor{keywordflow}{if} (spr\_mutex == 0) \{ \textcolor{comment}{// if we have finished adding things }
            ...
            \textcolor{keywordflow}{while} (spr\_queue != 0xff) \{
                ...
                \hyperlink{a00323_aaf545b3f811f6ef4b7c4be434701a77a}{dmaCopyVram}(pgfx, padrgfx, 8*4*2); \hyperlink{a00323_aaf545b3f811f6ef4b7c4be434701a77a}{dmaCopyVram}(pgfx+8*4*16, padrgfx+8
      *4*8, 8*4*2);
                spr\_queue--;
            \}
        \}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \textcolor{keywordflow}{while}(1) \{
        ...
        \textcolor{keywordflow}{if} (pad0) \{
            ...
            \textcolor{keywordflow}{if}(pad0 & \hyperlink{a00335_aa27cad8fa018a58930b6622783a83072aa7b3a3d0503a46bec51c6e3da95747cc}{KEY\_A}) \{
