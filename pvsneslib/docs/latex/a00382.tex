\hypertarget{a00382}{}\section{graphics/\+Sprites/\+Animated\+Sprite/\+Animated\+Sprite.\+c}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{void}) \{
    ...
    \hyperlink{a00320_a46e0be47f8fc865a7f43c1b0b126e59a}{oamInitGfxSet}(&gfxpsrite, (&gfxpsrite\_end-&gfxpsrite), &palsprite, (&palsprite\_end-&
      palsprite), 0, 0x0000, \hyperlink{a00320_a35664c2c4a66c3bac8139ae093d7f3ac}{OBJ\_SIZE16});

    \textcolor{comment}{// Define sprites parameters}
    \hyperlink{a00320_a2f62a591672b786d90ebb03fdf25f159}{oamSet}(0,  monster.x, monster.y, 0, 0, 0, 0, 0); 
    \hyperlink{a00320_a4120a8ff32c39973babeca3615a0a2fd}{oamSetEx}(0, OBJ\_SMALL, OBJ\_SHOW);
    \hyperlink{a00320_a35a0da9852240ef41b5030ed21b6eeb2}{oamSetVisible}(0,OBJ\_SHOW);
    ...
    \textcolor{keywordflow}{while}(1) \{
        ...
        \textcolor{keywordflow}{if} (pad0) \{
            ...
            \textcolor{keywordflow}{if}(pad0 & \hyperlink{a00305_aa27cad8fa018a58930b6622783a83072a0848a442d907968b211b97bc2bd88acd}{KEY\_UP}) \{
                \textcolor{keywordflow}{if}(monster.y >= SCREEN\_TOP) monster.y--;
                monster.state = W\_UP;
                monster.flipx = 0;
            \}
            \textcolor{keywordflow}{if}(pad0 & \hyperlink{a00305_aa27cad8fa018a58930b6622783a83072a612120b69c7dfd46086db7aaebdbcf65}{KEY\_LEFT}) \{
                \textcolor{keywordflow}{if}(monster.x >= SCREEN\_LEFT) monster.x--;
                monster.state = W\_LEFT;
                monster.flipx = 1;
            \}
            \textcolor{keywordflow}{if}(pad0 & \hyperlink{a00305_aa27cad8fa018a58930b6622783a83072a6504370d9c6391e1a9da6a1a529b089d}{KEY\_RIGHT}) \{
                \textcolor{keywordflow}{if}(monster.x <= SCREEN\_RIGHT) monster.x++;
                monster.state = W\_LEFT;
                monster.flipx = 0;
            \}
            \textcolor{keywordflow}{if}(pad0 & \hyperlink{a00305_aa27cad8fa018a58930b6622783a83072aa9cdac7967bf7d88fdb761138a2a3416}{KEY\_DOWN}) \{
        ...
        \hyperlink{a00320_a2f62a591672b786d90ebb03fdf25f159}{oamSet}(0,  monster.x, monster.y, 3, monster.flipx, 0, monster.gfx\_frame, 0);
