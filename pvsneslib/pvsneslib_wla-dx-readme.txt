Short:        GB-Z80/Z80/6502/65C02/6510/65816/HUC6280/SPC-700 Macro Assembler Package
Author:       Ville Helin
...
--------------------------------------------------------------------------------
-
 WLA DX GB-Z80/Z80/6502/65C02/6510/65816/HUC6280/SPC-700 Macro Assembler
Package
...
ROM image into the project with .BACKGROUND and insert e.g., OVERWRITE
.SECTIONs
...
GB-Z80/Z80/6502/65C02/6510/65816/HUC6280/SPC-700 linker. I use plain WLA to
refer
...
[Z80] .SDSCTAG 1.0, "DUNGEON MAN", "A wild dungeon exploration game", "Ville
Helin"
[Z80] .SMSTAG
...
.SDSCTAG {version number}, {program name}, {program release notes}, {program
author}
...
With .BACKGROUND defined you can leave away .ROMSIZE,.ROMTYPE and
.RAMTYPE. .BACKGROUND can be used only when compiling an object file.
...
If the value of DEBUG is less or equal to 2, then the following piece of code
is
acknowledged until .ENDIF/.ELSE occurs in the text, otherwise it is skipped.
Both arguments can be computations, defines or immediate values.
...
If the value of DEBUG is greater or equal to 2, then the following piece of code
is
acknowledged until .ENDIF/.ELSE occurs in the text, otherwise it is skipped.
Both arguments can be computations, defines or immediate values.
...
"wlalink [-divs]{b/r} <LINK FILE> <OUTPUT FILE>"
...
machines, among other things. I work at the Helsinki University of Technology
(http://www.hut.fi) as a researcher. I like Game Boy (goes without saying),
anime soap operas, gym and hardcore video gaming.
...
- Madonna MkII (Matra Computer Corp.), Mike Blum, Anders Montonen,
  Robert Kihl, Martin Konrad, Arto Salmi, Maxim, Yoshiaki Ishida
  Tobias Pflug, Brad Jorsch and Michel Iwaniec for reporting bugs in WLA
...
parts mentioned in section 19, in 1998-2004. WLA DX is GPL software. For
